...
from scim_server.mssql_provider.mssql_user_provider import MssqlUserProvider
from scim_server.mssql_provider.mssql_group_provider import MssqlGroupProvider
...
class MssqlProvider(ProviderBase):
    ...
    def __init__(self):
        self.group_provider = MssqlGroupProvider()
        self.user_provider = MssqlUserProvider()

    @property
    def resource_types(self):
        return MssqlProvider.Types

    @property
    def schema(self):
        return MssqlProvider.TypeSchema
