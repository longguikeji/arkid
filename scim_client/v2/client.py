...
class SCIMClient:
    ...
    def api_call(
        ...
        *,
        ...
        """Performs a Scim API request and returns the result."""
        ...
        *,
        ...
        try:
            ...
            if url.lower().startswith("http"):
                ...
                raise ScimRequestError(f"Invalid URL detected: {url}")
            ...
            self.logger.error(f"Failed to send a request to Scim API server: {err}")
            raise err
