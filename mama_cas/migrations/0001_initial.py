    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(verbose_name='user', to='core.user', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='proxygrantingticket',
            name='user',
            field=models.ForeignKey(verbose_name='user', to='core.user', on_delete=models.CASCADE),
            preserve_default=True,
        ),
    ]
