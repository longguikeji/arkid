...
urlpatterns = [
    ...
    url(r'^perm/user/(?P<user_id>[\w]+)/$', perm_views.UserPermView.as_view(), name='user_perm'),
    ...
    url(r'^config/contacts/$', ContactsConfigAPIView.as_view(), name='contacts_config'),
