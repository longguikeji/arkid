...
register_event(CREATE_APP_CONFIG, _('create app', '创建应用'))
register_event(CREATE_APP_CONFIG_DONE, _('create app done', '创建应用完成'))
register_event(UPDATE_APP_CONFIG, _('update app', '修改应用'))
