...
class Saml2IdpAliyunRamConfigSerializer(serializers.Serializer):  # pylint: disable=abstract-method
    """
    序列器
...
class Saml2IdpAliyunRamSerializer(AppBaseSerializer):
    """
    APP序列器
    """

    data = Saml2IdpAliyunRamConfigSerializer(label=_('SP配置'))
