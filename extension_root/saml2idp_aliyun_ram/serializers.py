...
class SAMLasIDPAliyunRamConfigSerializer(serializers.Serializer):  # pylint: disable=abstract-method
    """
    序列器
...
class SAMLasIDPAliyunRamSerializer(AppBaseSerializer):  # pylint: disable=abstract-method
    """
    APP序列器
    """

    data = SAMLasIDPAliyunRamConfigSerializer(label=_('SP配置'))
