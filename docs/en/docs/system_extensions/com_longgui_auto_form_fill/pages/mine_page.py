...
tag = 'auto_form_fill_account_mine'
name = '账密代填账户'
...
auto_form_fill_account_page.create_actions(
    init_action=actions.DirectAction(
        path='/api/v1/tenant/{tenant_id}/com_longgui_auto_form_fill/auto_form_fill/mine/accounts/',
    ...
    local_actions={
        ...
        "delete":actions.DeleteAction(
            path="/api/v1/tenant/{tenant_id}/com_longgui_auto_form_fill/auto_form_fill/mine/accounts/{id}/",
        )
    },
)
