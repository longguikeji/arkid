...
# 单独的页面配置
user_group_list_page.global_action['custom_field'] = actions.OpenAction(
    name=("自定义字段"),
...
custom_field_page.create_actions(
    init_action=actions.DirectAction(
        path='/api/v1/tenant/{tenant_id}/com_longgui_custom_field/custom_fields/?subject=user_group',
