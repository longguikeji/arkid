...
@api.get("/tenant/{tenant_id}/permission_groups/", tags=["权限分组"],auth=None)
def get_permission_groups(request, tenant_id: str):
    """ 权限分组列表,TODO
    """
    return []

@api.get("/tenant/{tenant_id}/permission_groups/{id}/", tags=["权限分组"],auth=None)
...
@api.get("/tenant/{tenant_id}/permission_groups/{permission_group_id}/permissions/", tags=["权限分组"],auth=None)
...
@api.get("/tenant/{tenant_id}/permission_groups/{permission_group_id}/select_permissions/", tags=["权限分组"],auth=None)
