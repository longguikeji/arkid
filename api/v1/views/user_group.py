...
@api.get("/tenant/{tenant_id}/user_groups/", tags=[_("用户分组")])
def get_user_groups(request, tenant_id: str):
    """ 用户分组列表,TODO
    """
    return []

@api.get("/tenant/{tenant_id}/user_groups/{id}/", tags=[_("用户分组")])
def get_user_group(request, tenant_id: str, id: str):
    """ 获取用户分组,TODO
    """
    return {}

@api.post("/tenant/{tenant_id}/user_groups/", tags=[_("用户分组")])
def create_user_group(request, tenant_id: str):
    """ 创建用户分组,TODO
    """
    return {}

@api.put("/tenant/{tenant_id}/user_groups/{id}/", tags=[_("用户分组")])
def update_user_group(request, tenant_id: str, id: str):
    """ 编辑用户分组,TODO
    """
    return {}

@api.delete("/tenant/{tenant_id}/user_groups/{id}/", tags=[_("用户分组")])
def delete_user_group(request, tenant_id: str, id: str):
    """ 删除用户分组,TODO
    """
    return {}

@api.get("/tenant/{tenant_id}/user_groups/{user_group_id}/users/", tags=[_("用户分组")])
def get_users_from_group(request, tenant_id: str, user_group_id: str):
    """ 获取当前分组的用户列表,TODO
    """
    return {}

@api.delete("/tenant/{tenant_id}/user_groups/{user_group_id}/users/{id}/", tags=[_("用户分组")])
def remove_user_from_group(request, tenant_id: str, user_group_id: str,id:str):
    """ 将用户移除出用户分组,TODO
    """
    return {}

@api.post("/tenant/{tenant_id}/user_groups/{user_group_id}/users/", tags=[_("用户分组")])
def update_users_from_group(request, tenant_id: str, user_group_id: str):
    """ 更新当前分组的用户列表,TODO
    """
    return {}

@api.get("/tenant/{tenant_id}/user_groups/{user_group_id}/select_users/", tags=[_("用户分组")])
