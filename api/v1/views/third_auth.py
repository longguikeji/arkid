...
@api.get("/tenant/{tenant_id}/third_auths/", tags=["第三方认证"],auth=None)
def get_third_auths(request, tenant_id: str):
    """ 第三方认证列表,TODO
    """
    return []

@api.get("/tenant/{tenant_id}/third_auths/{id}/", tags=["第三方认证"],auth=None)
def get_third_auth(request, tenant_id: str, id: str):
    """ 获取第三方认证,TODO
    """
    return {}

@api.post("/tenant/{tenant_id}/third_auths/", tags=["第三方认证"],auth=None)
