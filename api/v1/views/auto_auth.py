...
@api.get("/tenant/{tenant_id}/auto_auths/", tags=["自动认证"],auth=None)
def get_auto_auths(request, tenant_id: str):
    """ 自动认证列表,TODO
    """
    return []

@api.get("/tenant/{tenant_id}/auto_auths/{id}/", tags=["自动认证"],auth=None)
def get_auto_auth(request, tenant_id: str, id: str):
    """ 获取自动认证,TODO
    """
    return {}

@api.post("/tenant/{tenant_id}/auto_auths/", tags=["自动认证"],auth=None)
def create_auto_auth(request, tenant_id: str):
    """ 创建自动认证,TODO
    """
    return {}

@api.put("/tenant/{tenant_id}/auto_auths/{id}/", tags=["自动认证"],auth=None)
