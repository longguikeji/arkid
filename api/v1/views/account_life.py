...
@api.get("/tenant/{tenant_id}/account_lifes/", tags=["账号生命周期"],auth=None)
def get_account_life_list(request, tenant_id: str):
    """ 账号生命周期配置列表,TODO
    """
    return []

@api.get("/tenant/{tenant_id}/account_lifes/{id}/", tags=["账号生命周期"],auth=None)
def get_account_life(request, tenant_id: str, id: str):
    """ 获取账号生命周期配置,TODO
    """
    return {}

@api.post("/tenant/{tenant_id}/account_lifes/", tags=["账号生命周期"],auth=None)
def create_account_life(request, tenant_id: str):
    """ 创建账号生命周期配置,TODO
    """
    return {}

@api.put("/tenant/{tenant_id}/account_lifes/{id}/", tags=["账号生命周期"],auth=None)
