...
urlpatterns = [
    ...
    re_path(r'^tenant/(?P<tenant_uuid>[\w-]+)/contactsconfig/info_visibility/(?P<info_uuid>[\w-]+)/detail/', views_tenant.TenantContactsConfigInfoVisibilityDetailView.as_view(), name='tenant-contactsconfig-info-visibility-detail'),
    ...
    re_path(r'^tenant/(?P<tenant_uuid>[\w-]+)/contacts/group/', views_tenant.TenantContactsGroupView.as_view(), name='tenant-contacts-group'),
    re_path(r'^tenant/(?P<tenant_uuid>[\w-]+)/contacts/user/', views_tenant.TenantContactsUserView.as_view(), name='tenant-contacts-user'),
    re_path(r'^tenant/(?P<tenant_uuid>[\w-]+)/contacts/user_tags/', views_tenant.TenantContactsUserTagsView.as_view(), name='tenant-contacts-user-tags'),
