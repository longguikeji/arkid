...
base_urlpatterns = [
    re_path(r"oauth/token/$", views.TokenView.as_view(), name="token"),
    re_path(r"oauth/revoke_token/$", views.RevokeTokenView.as_view(), name="revoke-token"),
    re_path(r"oauth/introspect/$", views.IntrospectTokenView.as_view(), name="introspect"),
]

oidc_urlpatterns = [
    re_path(r"app/(?P<app_id>[\w-]+)/.well-known/openid-configuration/$", views.ConnectDiscoveryInfoView.as_view(), name="oidc-connect-discovery-info",),
    re_path(r"oauth/userinfo/$", views.UserInfoExtendView.as_view(), name="oauth-user-info"),
    re_path(r"oidc/logout/$", views.OIDCLogoutView.as_view(), name="oauth-user-logout"),
...
# oauth_urlpatterns = [
#     re_path(r"oauth/authorize/$", views.AuthorizationView.as_view(), name="authorize"),
# ]
...
#     re_path(r"^oauth/userinfo/$", views.IntrospectTokenView.as_view(), name="introspect"),
# ]
...
#     ),
#     # re_path(
#     #     r'^tenant/(?P<tenant_uuid>[\w-]+)/\.well-known/openid-configuration/$',
#     #     views.ConnectDiscoveryInfoView.as_view(),
#     #     name='oidc-connect-discovery-info',
#     # ),
#     re_path(r"^\.well-known/jwks.json$", views.JwksInfoView.as_view(), name="jwks-info"),
